    ...
    GoogleProvider({
      ...
      authorization: {
        params: {
          ...
          response_type: 'code',
          scope:
            'openid profile email https://www.googleapis.com/auth/youtube https://www.googleapis.com/auth/youtube.force-ssl https://www.googleapis.com/auth/youtube.readonly',
        },
      },
    }),
  ],
