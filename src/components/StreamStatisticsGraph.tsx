import { Accordion, AccordionContent, AccordionItem, AccordionTrigger, Avatar, AvatarFallback, AvatarImage, Button } from '@/imports/Shadcn_imports'
  ...
  return (
    <div className="bg-white p-3 rounded-lg shadow h-full">
      ...
      <div className="h-5/6  p-2 overflow-y-scroll">
        ...
        {data.map((e) => {
          return <Accordion type="single" collapsible key={e.id} className='shadow'>
