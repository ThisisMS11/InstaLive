...
export const createLiveStreamDB = async (liveStreamResponse: any, userId: string) => {
    console.log({ userId });
...
export const createBroadcastDB = async (broadCastResponse: any, liveStreamId: string, userId: string) => {
    return prisma.broadcast.create({
        data: {
            ...
            privacyStatus: broadCastResponse.status.privacyStatus as privacyStatusEnum,
