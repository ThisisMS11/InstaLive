...
const logger: Logger = createLogger({
    ...
    transports: [
        new transports.File({ filename: '/home/mohit/Desktop/Visual-Studio-Code/Web-development/top-projects/Dekh Mera Video/liveme/src/app/api/logs/error.log', level: 'error' }),
        new transports.File({ filename: '/home/mohit/Desktop/Visual-Studio-Code/Web-development/top-projects/Dekh Mera Video/liveme/src/app/api/logs/combined.log' }),
    ],
});
